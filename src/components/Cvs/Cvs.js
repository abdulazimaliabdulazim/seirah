...
const Cvs = () => {
  const [seirsAll, setSeirsAll] = useState(
    getFormValues(false, "countseirah", true, false, "", "", "", "", [])
  );
  window.localStorage.setItem("countseirah", JSON.stringify(seirsAll));
            ...
            <div key={ind} className={style.box}>
              <div className={style.parent}>
                <Link
                  ...
                  <UserImg
                    srcImg={
                      allSeirah("personal")[coun[2]++] !== undefined
                        ? allSeirah("personal")[coun[3]++].srcImg1
                        : ""
                    }
                    radius="50%"
                  />
                  <div className={style.col}>
                    ...
                    <h4>
                      {allSeirah("personal")[coun[0]++] !== undefined
                        ? allSeirah("personal")[coun[1]++].name
                        : ""}
                    </h4>
                  </div>
                </Link>
